function [] = generate_trim_comparison_plots_reduced_data(perf_metrics_MC,perf_metrics_MC2,perf_metrics_MC3,perf_metrics_MC4,perf_metrics_MC5,perf_metrics_mean,perf_metrics_mean2,perf_metrics_mean3,perf_metrics_mean4,perf_metrics_mean5)
...
plot([perf_metrics_mean5.normal.alpha_deg,perf_metrics_mean5.normal.alpha_deg],[0 1],'--');
...
box on; grid on;
saveas(gcf,'images/trim_aoa_reduced_data.png');
