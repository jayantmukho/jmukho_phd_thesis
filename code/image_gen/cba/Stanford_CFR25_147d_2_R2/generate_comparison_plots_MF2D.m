function [] = generate_comparison_plots_MF2D(perf_metrics_MC,perf_metrics_MC2,perf_metrics_mean,perf_metrics_mean2)
figure; hold on;
...
legend('Normal (Full)','R. Engine Out (Full)','L. Engine Out (Full)','Normal (MF-GP)','R. Engine Out (MF-GP)','L. Engine Out (MF-GP)','FontWeight','bold');
