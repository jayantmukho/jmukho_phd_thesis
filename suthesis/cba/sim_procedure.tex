...
This is confirmed looking at Figure \ref{fig:eo_cfr147d_inputs}

\begin{figure}
    \centering
    \begin{subfigure}[Roll accelerations required for the maneuver with inoperative engines.] {
    ...
    \end{subfigure}
    \caption{Rudder and elevator control inputs are required to satisfy the yaw and pitch accelerations needed to complete the maneuver.  \label{fig:eo_cfr147d_inputs}}
\end{figure}
