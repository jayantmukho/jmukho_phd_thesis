...
WT_Mach85 = filtering_data(WT_Mach85,0.5);
...
errorbar(WT_Mach85.alpha(WT_ind_inv),WT_Mach85.CD(WT_ind_inv),2*WT_Mach85.CD_sig(WT_ind_inv),...
    'k*','LineWidth',2,'MarkerSize',10);
xlabel('$\alpha$')
ylabel('$C_D$')
plots = get(gca,'children');
legend([plots(4) plots(3) plots(2) plots(5) plots(6) plots(1)],'AVL Data','SU2 Data','WT Data','GP Mean','$2\sigma$','Unused WT Data','Location','northwest')
...
errorbar(WT_Mach85.alpha(WT_ind),WT_Mach85.CD(WT_ind),2*WT_Mach85.CD_sig(WT_ind),...
...
plots = get(gca,'children');
legend([plots(2) plots(3) plots(4) plots(1)],'WT Data','GP Mean','$2\sigma$','Unused WT Data','Location','northwest')
axis square
axis(axis_range)
...
errorbar(WT_Mach85.alpha(WT_ind),WT_Mach85.CD(WT_ind),2*WT_Mach85.CD_sig(WT_ind),...
    'x','LineWidth',2,'MarkerSize',10,'color',colorOrder(4,:));
% errorbar(WT_Mach85.alpha(WT_cv),WT_Mach85.CD(WT_cv),2*WT_Mach85.CD_sig(WT_cv),'x','LineWidth',2);
% my_GP.plot_GP_1D_slice(x_samp,x_samp)
xlabel('$\alpha$')
ylabel('$C_D$')
legend('Unused WT Data','Used WT Data','Location','northwest')
axis square
axis(axis_range)
...
figure(1);
saveas(gcf,'images/cd_3f_partial','png')

figure(2);
saveas(gcf,'images/cd_hf_partial','png')

figure(3);
saveas(gcf,'images/cd_hf_all','png')
