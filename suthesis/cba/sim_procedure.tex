...
To analyze the distribution of the success metrics, cumulative distribution functions (CDF) are used. 
...
The CDF of each of the metrics for each engine-out situation is shown in Figure \ref{}.
