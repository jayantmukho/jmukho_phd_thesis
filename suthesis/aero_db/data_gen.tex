...
\begin{figure}
    ...
    \end{subfigure}
    \caption{Visualization of the 2-Dimensional AVL, SU2, and wind tunnel data and resulting three-fidelity GP for the rolling moment coefficient. \label{fig:gtt_2f_data_gps}}
\end{figure}
