function [] = generate_comparison_plots(perf_metrics_MC,perf_metrics_MC2,perf_metrics_mean,perf_metrics_mean2)
figure; hold on;
...
legend('Normal (Full)','R. Engine Out (Full)','L. Engine Out (Full)','Normal (Sparse)','R. Engine Out (Sparse)','L. Engine Out (Sparse)','FontWeight','bold');
