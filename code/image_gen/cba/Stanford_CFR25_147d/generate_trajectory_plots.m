...
plot(CPR_data_mean.qdot_dps2.time,CPR_data_mean.qdot_dps2.values,'k','LineWidth',lw);
for i=1:length(idx_list)
...
plot(CPR_data_mean.rdot_dps2.time,CPR_data_mean.rdot_dps2.values,'k','LineWidth',lw);
for i=1:length(idx_list)
