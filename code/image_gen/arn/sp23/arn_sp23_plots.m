...
opts = detectImportOptions('Tx_X_SP23_1ptn_Sym.dat');
expData = readmatrix('Tx_X_SP23_1ptn_Sym.dat',opts);
opts = detectImportOptions('Tx_X_SP23_1ptn_Sig.dat');
expErr = readmatrix('Tx_X_SP23_1ptn_Sig.dat',opts);
nExp = size(expData,1);
...
axis([.8,4.7,0,1.3])
saveas(gcf,'images/arn_sp23_vel_prof.png')
...
axis([1,15,0,1.4])
saveas(gcf,'images/arn_sp23_center_vel.png')
%% TKE Plots
gray=1/255*[200,200,200];
...
saveas(gcf,'images/arn_sp23_k_prof.png')