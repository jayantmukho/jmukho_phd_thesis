function [] = generate_trim_comparison_plots_MF2D(perf_metrics_MC,perf_metrics_MC2,perf_metrics_MC3,perf_metrics_mean,perf_metrics_mean2,perf_metrics_mean3)
figure; hold on;
...
legend('Full WT dataset','AVL dataset','AVL+SU2 dataset','FontWeight','bold');
